...
@Autonomous(name = "Score2SpecimenRight", group = "Autonomous")

public class Score2SpecimenRight extends LinearOpMode {
...
//***************************** Put Auto Code Under Here To Run :o (please work) *******************
            ...
            TurnRightDegrees(1.0,90);

            Pause(400);
            ResetWheelEnoders();

            StrafeLeftTilesTimer(1.0,0.4, 1000);

            Pause(400);
            ResetWheelEnoders();

            SetArmPosition(1.0,-35);


            MoveTilesTimer(1.0, 1.7, 3000);
...
//************************************ Autonomous Functions :) *************************************
    ...
    {
        MovebotAndRaiseArmAndMoveSlideWithTimer(1.0,-17, 2000, 1.0, -60, -1.0, ViperSlideSpecimenPosition);
    ...
    public void StrafeLeftTilesTimer(double Power, double TileCount, long time)
    {
        StrafePositionTimer(Power, (int)(-24 * TileCount), time);
    }

    public void StrafeRightTilesTimer(double Power, double TileCount, long time)
    {
        StrafePositionTimer(Power, (int)(24 * TileCount), time);
    }
    ...
    public void MoveTilesTimer(double Power, double TileCount, long time)
    {
        MovePositionTimer(Power, (int)(-24 * TileCount), time);
    }
    ...
    public void StrafePositionTimer(double power, int position, long timeoutMillis)
    {
        int targetPosition = (int) (position * countsPerInch);
        double Correction = 1.00;
        targetPosition *= Correction;
