...
@Autonomous(name = "Score2inBucket", group = "Autonomous")

public class Score2inBucket extends LinearOpMode {
...
//***************************** Put Auto Code Under Here To Run :o (please work) *******************
        ...
        StrafeRightTiles(1.0,1.0);

        Pause(300);
        ResetWheelEnoders();

        TurnLeftDegrees(1.0,42);
        Pause(300);

        SetArmPosition(1.0,-90);
        SetViperSlidePositionTimer(1.0, -70,2500);
...
//************************************ Autonomous Functions :) *************************************
    ...
    public void ScoreStartingSpecimen()
    {
        ...
        //MoveTiles(1.0,0.75);
        MoveWrist(WristSpecimenPosition - 2);
